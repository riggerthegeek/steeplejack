            ...
            describe("#filter", function () {
                ...
                describe("single property", function () {
                    ...
                    it("should filter no results", function () {
                        ...
                        expect(orig.get(0)).to.be.equal(out.get(0));
                        expect(orig.get(1)).to.be.equal(out.get(1));
                        expect(orig.get(2)).to.be.equal(out.get(2));
        ...
        describe("#limit", function () {
            ...
            it("should return the correct number of items specified", function () {
                ...
                for (var i = 1; i < 3; i++) {
                    ...
                    expect(newObj.toJSON()).to.be.eql(raw.slice(0, i));
            ...
            it("should return all items when the limit is greater than the count", function () {
                ...
                expect(obj.toJSON()).to.be.eql(raw);
            ...
            it("should offset the number of items", function () {
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    expect(newObj.toJSON()).to.be.eql([
                        raw[i]
                    ]);
