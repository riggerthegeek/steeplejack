...
export abstract class Collection extends Base {
    ...
    public each (iterator : Function, thisArg: Object = null) : Collection {
        ...
        _.each(collection, (data: Steeplejack.ICollectionData) => {
    ...
    public eachRight (iterator : Function, thisArg: Object = null) : Collection {
        ...
        _.eachRight(collection, (data: Steeplejack.ICollectionData) => {
            return iterator.call(thisArg, data.model, data.id, collection);
        });
     ...
     *
     * @returns {Steeplejack.ICollectionData[]}
     */
    public getAll () : Steeplejack.ICollectionData[] {
    ...
    public getAllById (ids : string[]) : Model[] {
        ...
        let keys = _.reduce(this.getAll(), (result: any, data: Steeplejack.ICollectionData, key: number) => {
    ...
    public getAllByKey (id : number[]) : Model[] {
        ...
        return _.reduce(this.getAll(), (result: any, data: Steeplejack.ICollectionData, key: number) => {
     ...
     */
    public getData () : any[] {
        return _.map(this.getAll(), (item: Steeplejack.ICollectionData) => {
    ...
    public sort (fn: (a: any, b: any) => number) : Collection {
        ...
        this._order = _.reduce(sorted, (result: string[], data: Steeplejack.ICollectionData) => {
            result.push(data.id);
     ...
     *
     * @param {Steeplejack.ISortProperty} properties
     * @returns {Collection}
     */
    public sortBy (properties : Steeplejack.ISortProperty ) : Collection {
        ...
        return this.sort((a: Steeplejack.ICollectionData, b: Steeplejack.ICollectionData) => {
    ...
    public validate () : boolean {
        ...
        _.each(this.getAll(), (item: Steeplejack.ICollectionData, id: number) => {
